      ...
      <ha-card>
        <div class="ff-wrap">
          <svg viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg">
            ...
            <g transform="translate(${hub.cx - 16},${hub.cy - 16})">${ICONS.hub}</g>
          </svg>
        </div>
      </ha-card>
      <style>
...
const ICONS = {
  ...
  hub: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" width="32" height="32">
    <text x="20" y="27" font-size="22" font-weight="700" font-family="inherit" text-anchor="middle" fill="#fff">F</text>
  </svg>`,
};
